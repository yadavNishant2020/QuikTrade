              ...
              <span
                className={
                  (globlemltRealized > 0
                    ...
                    : globlemltRealized === 0
                    ? " text-data-secondary"
                    : " text-danger") + " m-1 font-14px  text-center"
                }
              >
                {globlemltRealized > 0 ? "+" : ""}
                {Constant.CurrencyFormat(globlemltRealized)}
              </span>
            </Col>
          </Row>
          <Row>
            <Col xl="12" className="closeorderlist">
              <div className="table-container">
                <Table className="align-items-center CloseOrderList">
                  ...
                  <tbody>
                    {closePositionList !== undefined &&
                      closePositionList !== null &&
                      closePositionList.length > 0 &&
                      closePositionList?.map((data) => (
                        <tr key={data.orderid}>
                          <td className="text-center">
                            <span
                              className={
                                data.closepositionproductname.toLowerCase() ===
                                "mis"
                            ...
                            {data.closepositionstrike === "0" ? (
                              ...
                              <>
                                ...
                                {Constant.ConvertShortDate(
                                  data.closepositionexpirydate
                                )}{" "}
                                {data.closepositionstrike}{" "}
                                {data.closepositionordertype}
                              </>
                            )}
                          </td>
