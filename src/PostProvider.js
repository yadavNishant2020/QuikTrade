...
const PostProvider = ({ children }) => {
  ...
  const [globleCurrentStockIndex, setGlobleCurrentStockIndex] =
    useState("0.00");
  const [globleCurrentStockIndexFuture, setGlobleCurrentStockIndexFuture] =
    useState("0.00");
  ...
  const [globleSelectedTradingType, setGlobleSelectedTradingType] =
    useState("");
  const [globleOptionListForSymbol, setGlobleOptionListForSymbol] = useState(
    []
  );
  const [globleOptionList, setGlobleOptionList] = useState([]);
  const [globleOptionListForSymbolForLTP, setGlobleOptionListForSymbolForLTP] =
    useState([]);
  ...
  const [globleChangeDefaultSetting, setGlobleChangeDefaultSetting] =
    useState(0);
